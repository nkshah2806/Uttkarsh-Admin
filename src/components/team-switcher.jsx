        ...
        <SidebarMenuButton size="lg" className="bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/60 h-auto overflow-hidden rounded-xl p-2.5 transition-all">
          ...
          <div className="flex flex-col flex-1 text-left leading-tight ml-1">
            <div className="flex items-center gap-1.5">
              <span className="truncate font-bold text-sm tracking-tight text-indigo-950 dark:text-indigo-100">Uttkarsh Corporation</span>
            ...
            <span className="truncate text-[11px] font-medium text-indigo-600/80 dark:text-indigo-300/80">Corporation Admin</span>
          </div>
        </SidebarMenuButton>
      </SidebarMenuItem>
    </SidebarMenu>
